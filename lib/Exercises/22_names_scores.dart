...
/// Using p022_names.txt (right click and 'Save Link/Target As...'), a 46K text file containing over five-thousand first names, begin by sorting it into alphabetical order.
...
main() {
  List<String> names = File('lib/Exercises/aux/p022_names.txt')
      .readAsStringSync()
      .replaceAll('"', '')
      .split(',');
  names.sort((a, b) {
